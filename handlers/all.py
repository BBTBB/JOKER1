...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/"+BBTBB)],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/FFMFF")],[InlineKeyboardButton("قناة البوتات 🤖", url="t.me/BBTBB")]])
